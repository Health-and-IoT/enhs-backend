...
func main() {
	...
	r := mux.NewRouter()
	r.HandleFunc("/getPatient/{id}", getPatient).Methods("GET")
	r.HandleFunc("/getVisits/{id}", getVisits).Methods("GET")
	r.HandleFunc("/getUser/{id}", getUser).Methods("GET")
	r.HandleFunc("/getPatients/{id}", getPatients).Methods("GET")
	r.HandleFunc("/getAllEvents", getAllEvents).Methods("GET")
	r.HandleFunc("/updateForm/{id}", updateForm).Methods("POST")
	r.HandleFunc("/deleteForm/{id}", deleteForm).Methods("POST")
	r.HandleFunc("/getSite/{id}", getSite).Methods("GET")
	r.HandleFunc("/login/", authLogin).Methods("GET")
